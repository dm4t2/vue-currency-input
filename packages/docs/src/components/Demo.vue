...
const precisionRangeMinOptions = computed(() =>
  range(0, precisionRangeMaxValue.value + 1),
);
const precisionRangeMaxOptions = computed(() =>
  range(precisionRangeMinValue.value, 30),
);
  ...
  return {
    ...
    precision: precisionEnabled.value
      ? precisionRangeEnabled.value
        ? {
            min: precisionRangeMinValue.value,
            max: precisionRangeMaxValue.value,
          }
        : precision.value
      : undefined,
    ...
    hideNegligibleDecimalDigitsOnFocus:
      hideNegligibleDecimalDigitsOnFocus.value,
    ...
    >
      <div>
        ...
        <select
          ...
          class="form-input form-select"
        >
          <option v-for="value in precisionOptions" :key="value" :value="value">
            {{ value }}
          </option>
        </select>
      </div>
